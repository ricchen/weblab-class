  ...
  removeNubbins() {
    this.maze.slice(2, -2).forEach((row, idx) => {
      ...
      row.slice(2, -2).forEach((cell, idx) => {
        ...
        if (
          this.isA("wall", [r - 1, c - 1], [r - 1, c], [r - 1, c + 1], [r + 1, c]) &&
        ...
        if (
          this.isA("wall", [r - 1, c + 1], [r, c - 1], [r, c + 1], [r + 1, c + 1]) &&
        ...
        if (
          this.isA("wall", [r - 1, c - 1], [r, c - 1], [r + 1, c - 1], [r, c + 1]) &&
          this.isGap([r - 1, c + 1], [r, c + 2], [r + 1, c + 1])
        ) {
          this.maze[r][c] = [];
          this.maze[r][c + 1] = ["nubbin"];
        ...
        if (
          this.isA("wall", [r - 1, c], [r + 1, c - 1], [r + 1, c], [r + 1, c + 1]) &&
